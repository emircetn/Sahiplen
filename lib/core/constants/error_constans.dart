class AuthErrorConstants {
  static AuthErrorConstants? _instace;
  static AuthErrorConstants get instance {
    _instace ??= AuthErrorConstants._init();
    return _instace!;
  }

  AuthErrorConstants._init();

  String getAuthErrorText(String code) {
    switch (code) {
      case 'success':
